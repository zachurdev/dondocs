...
\\setSubject{${escapeLatex(subjectLine)}}
...
function generateJointLetterSignatoryTex(store: DocumentStore): string {
  ...
  return `%=============================================================================
% JOINT LETTER DUAL CONFIGURATION - Generated by libo-secured
...
`;
  ...
  // Handle custom classification - just output the text verbatim
  if (data.classLevel === 'custom' && data.customClassification) {
    return `%=============================================================================
% CUSTOM CLASSIFICATION - Generated by libo-secured
%=============================================================================

\\setClassification{${escapeLatex(data.customClassification)}}
`;
  }
